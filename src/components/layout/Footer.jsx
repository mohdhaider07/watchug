  ...
  <footer className="footer">
    <div className="footer-grid">
      <div>
        ...
        <p className="footer-desc">Your ultimate destination for movies and TV shows. Stream your favorites anytime, anywhere.</p>
      </div>
      <div>
      ...
      <div>
        ...
        <div className="footer-apps">
          <a href="#" className="footer-app"><FaApple /> App Store</a>
          <a href="#" className="footer-app"><FaGooglePlay /> Play Store</a>
        </div>
      </div>
    </div>
